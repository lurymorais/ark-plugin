...
- Simplified data collection: Only {naan, arks_count, plugin_version}
...
- Documentation: Installation, configuration, and API docs
...
|-------------------|--------|-------|
| Credential Storage | Tokens persisted on server | No credentials stored |
| Remote Access | Permanent pull access | Zero remote access |
| Data Privacy | Email, country, journal name | NAAN (public), count, version |
| Consent | No explicit consent | Opt-in required |
| Authentication | Bypass possible | Proper role validation |
| CSRF | Missing | Fully implemented |
| SQL Injection | Partial-suffix matching | Exact match only |
...
- Telemetry (Basic and Complete levels)
...
### 2026-07-01: Security Release 3.1.0.0

Addressed critical security vulnerabilities:
- CVE-2026-XXXX: Unauthenticated save_ajax.php endpoint
- CVE-2026-XXXX: Token regeneration mechanism with permanent access
- CVE-2026-XXXX: SQL injection in resolver (partial-suffix matching)
